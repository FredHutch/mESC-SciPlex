...
#Brandon loads also  
  ...
  library(garnett)
  setwd("/Users/hadlandlab/Desktop/1-13-22_EB_analysis_PAPER")
...
EB3_cds = readRDS("/Users/hadlandlab/Desktop/1-13-22_EB_analysis_PAPER/EB3.RDS")
...
genes = 
  read.table(file = "/Users/hadlandlab/Desktop/sciPlex_HSC3/gene.annotations",
             sep = "\t",
             header = F,
...
genes = read.table(file = "/Users/hadlandlab/Desktop/sciPlex_HSC3/gene.annotations", sep = "\t", header = F, col.names = c("f_id", "gene_short_name"))
