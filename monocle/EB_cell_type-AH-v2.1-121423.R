...
colData(EB3_assigned_cell_type_cds)$assigned_cell_type = dplyr::recode(colData(EB3_assigned_cell_type_cds)$assigned_cell_type,
        ...
        "36" = "Visceral endoderm",
        "47" = "Endoderm", "29" = "Endoderm",
        "30" = "Ectoderm", "41" = "Ectoderm",
...
#Graph Day 4
plot_cells(EB3_assigned_cell_type_D4_cds, group_cells_by = "cluster", color_cells_by = "assigned_cell_type", show_trajectory_graph = F, label_cell_groups = F,
           group_label_size = 4.5, label_groups_by_cluster =F, label_branch_points = F, label_roots = F, label_leaves = F,
           graph_label_size = 0.1, cell_size = 0.2) +
...
ggsave("FIG1D-Day4_EB_cds_assigned_cell_types.tiff", width = 4, height = 4, dpi = 300, bg = "transparent")
#Graph Day 5
...
ggsave("FIG1D-Day5_EB_cds_assigned_cell_types.tiff", width = 4, height = 4, dpi = 300, bg = "transparent")
#Graph Day 6
plot_cells(EB3_assigned_cell_type_D6_cds, group_cells_by = "cluster", color_cells_by = "assigned_cell_type", show_trajectory_graph = F, label_cell_groups = F,
           group_label_size = 4.5, label_groups_by_cluster =F, label_branch_points = F, label_roots = F, label_leaves = F,
           graph_label_size = 0.1, cell_size = 0.2) +
...
ggsave("FIG1D-Day6_EB_cds_assigned_cell_types.tiff", width = 4, height = 4, dpi = 300, bg = "transparent")
...
####Filter for expression of given markers#####
#Primitive streak
