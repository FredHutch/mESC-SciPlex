# Repository for Varnum-Finney & Heck et al. 2026

## Description

This is the repository containing the code used for analysis in the Varnum-Finney & Heck et al. 2026 paper.
...
### results:
- contains the final result tables
